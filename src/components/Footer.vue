<template>
    <footer class="text-left p-4 pt-12 bg-footer-color sm:p-6 dark:bg-gray-800">
        <div class="max-w-screen-xl mx-auto">
            ...
            <span class="text-sm text-gray-400 sm:text-center dark:text-gray-400">© 2023 <a href="https://etherisc.com" class="hover:underline">Etherisc</a>. All Rights Reserved.
            </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" class="text-gray-300 hover:text-gray-500 dark:hover:text-white">
