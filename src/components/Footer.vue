<template>
    <footer class="text-left p-4 bg-white sm:p-6 dark:bg-gray-800">
        <div class="max-w-screen-xl mx-auto">
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://etherisc.com" class="hover:underline">Etherisc™</a>. All Rights Reserved.
            </span>
