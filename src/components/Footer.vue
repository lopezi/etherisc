<template>
    <footer class="text-left p-4 pt-12 bg-yellow-600 sm:p-6 dark:bg-gray-800">
        <div class="max-w-screen-xl mx-auto">
            <div class="md:flex md:justify-between mt-8">
                <div class="mb-2 md:mb-0">
                    <a href="https://etherisc.com" class="flex items-center">
                        <img src="https://depeg.etherisc.com/etherisc_logo_white.svg" class="h-11 mr-3" alt="Etherisc Logotype" />
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                    <div>
                        <h2 class="mb-6 text-xl font-semibold text-white uppercase dark:text-white">Legal</h2>
                    ...
                    <div>
                        <h2 class="mb-6 text-xl font-semibold text-white uppercase dark:text-white">Resources</h2>
                        <ul class="text-yellow-300 dark:text-gray-400">
                            <li class="mb-4">
                    ...
                    <div>
                        <h2 class="mb-6 text-xl font-semibold text-white uppercase dark:text-white">Join us</h2>
                        <ul class="text-yellow-300 dark:text-gray-400">
                            <li class="mb-4">
            ...
            <hr class="my-6 border-yellow-700 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-yellow-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://etherisc.com" class="hover:underline">Etherisc</a>. All Rights Reserved.
            </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" class="text-yellow-900 hover:text-gray-900 dark:hover:text-white">
