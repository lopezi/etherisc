<template>
    <section class="bg-white bg-plateau dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:pt-24 lg:pb-12 lg:px-12">
            ...
            <p class="text-lg font-normal text-gray-600 lg:text-2xl sm:px-16 xl:px-48 dark:text-gray-400">Discover our leading, flexible, blockchain platform revolutionising the insurance ecosystem.</p>
