        ...
        <div class="text-left py-8 px-4 mx-auto max-w-screen-xl lg:py-24">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-10">
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Customers face challenges</h2>
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
                        Insurance customers face challenges with reimbursement from profit-driven corporations and miss out on life-changing benefits due to expensive, opaque, and inefficient policies.
                    </p>
                </div>
                <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-10">
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Providers face difficulties</h2>
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
                        Insurance companies struggle to balance shareholder and customer interests, incurring high operational costs and facing regulatory barriers for innovation.
                    </p>
                </div>
                <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-10">
